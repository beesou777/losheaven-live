<template>
  <!-- ====== About Section Start -->
  <section class="overflow-hidden pt-20 px-[20px] pb-12 lg:pt-[10px] lg:pb-[90px] bg-white dark:bg-dark">
      ...
      <div class="flex flex-wrap items-center justify-between -mx-4">
          ...
          <div class="flex items-center -mx-3 sm:-mx-4">
            <div class="w-full px-3 sm:px-4 xl:w-1/2">
              <div class="py-3 sm:py-4">
                <img src="https://i.postimg.cc/xTcbc7qG/6.jpg" alt="" class="w-full rounded-2xl" />
              </div>
              <div class="py-3 sm:py-4">
                <img
        ...
        <div class="w-full px-4 lg:w-1/2 xl:w-5/12">
          <div class="mt-10 lg:mt-0">
            <span class="block mb-4 text-lg font-semibold color-primary"> Why Choose Us </span>
            ...
            <NuxtLink
              to="/contact"
              class="inline-flex items-center justify-center py-3 text-base font-medium text-center text-white border border-transparent rounded-md px-7 lh-primary hover:bg-opacity-90"
            >
              Contact us
            </NuxtLink>
          </div>
