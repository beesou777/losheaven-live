<template>
  <div class="max-w-[1400px] mx-auto md:px-[40px] px-4">
    ...
    <ul class="text-gray-500 text-[18px] list-disc ms-5">
      ...
      <li>
        Usage Data: We may also collect information about how you interact with our website, including your IP address,
        browser type, pages visited, and time spent on each page.
      </li>
      <li>
        Cookies: Like many websites, we use cookies to enhance your browsing experience and gather information about our
    ...
    <ul class="text-gray-500 text-[18px] list-disc ms-5">
      <li>
        Order Fulfillment: We use your personal information to process orders, provide shipping updates, and communicate
        with you about your purchases.
      </li>
      <li>
        Personalization: We may use your information to personalize your shopping experience and recommend products that
        may interest you.
      </li>
      <li>
        Communication: With your consent, we may send you promotional emails about new products, special offers, and
        other updates.
      </li>
      <li>Improvement: We analyze usage data to improve our website, products, and services.</li>
    </ul>
    ...
    <p class="text-gray-500 text-[18px]">
      ...
      except as required by law or as necessary to fulfill your orders.
    </p>
    ...
    <p class="text-gray-500 text-[18px]">
      ...
      receiving promotional emails by following the unsubscribe instructions included in these communications.
    </p>
