<template>
  <section
    class="w-full max-w-lg overflow-y-auto bg-white shadow-lg rounded-md fixed !z-[9999] top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%]"
  >
    <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
      <svg
        @click="emit('register-success')"
      ...
      <form class="space-y-4 md:space-y-6" action="#">
        ...
        <button
          type="submit"
          @click="Login"
          class="w-full text-gray-900 text-[18px] lh-primary focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg px-5 py-2.5 text-center dark:lh-primary dark:focus:ring-primary-800"
        >
          Sign up
        </button>
      </form>
