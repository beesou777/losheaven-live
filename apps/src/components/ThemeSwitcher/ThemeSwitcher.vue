...
<template>
  <div class="flex items-center">
    ...
    >
      ...
      <HeadlessListboxButton type="template">
        <div class="text-gray-600">
          ...
          <span class="justify-center items-center hidden">
            <Icon name="uil:moon" />
          </span>
        </div>
      ...
      >
        <HeadlessListboxOption
          ...
          :class="{
            ...
            'text-sky-500 bg-gray-100 ': $colorMode.preference === theme.key,
            'hover:bg-gray-50 ': $colorMode.preference !== theme.key,
          }"
        >
    ...
    <select
      ...
      v-model="$colorMode.preference"
      class="w-full px-2 pr-3 py-1 outline-none rounded border bg-transparent text-gray-700"
    >
